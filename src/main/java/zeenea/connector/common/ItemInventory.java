...
public final class ItemInventory {
  ...
  /**
   * Datasource identifier associated with the inventory item. A null check is performed on scanner
   * side to ensure backward compatibility with previous versions.
   */

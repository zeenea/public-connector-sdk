...
/**
 * A utility class to create {@link Connector} instances following the Factory design pattern, doubling as an {@link ExtensionPoint} for discoverability from the Scanner.
 *
 * @see Connector
...
public interface ConnectorFactory extends ExtensionPoint {
    ...
    /**
     * Called from Scanner in order to list available connector factories.
     * As there is no guarantee that this method will be called only once, it is considered to always return the same value.
     *

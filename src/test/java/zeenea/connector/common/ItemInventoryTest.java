...
class ItemInventoryTest {
  ...
  @Test
  @DisplayName("ItemInventory factory should fail with null datasource identifier")
  @SuppressWarnings("DataFlowIssue")
  void shouldFailWithNullDataSourceIdentifier() {
    ItemIdentifier identifier =
        ItemIdentifier.of(List.of(IdentificationProperty.of("key", "value")));
    LabelIdentifier labelIdentifier =
        LabelIdentifier.of(
            ...
            IdentificationProperty.of("label2", "value2"));
    assertThrows(
        NullPointerException.class, () -> ItemInventory.of(identifier, labelIdentifier, null));
  }
}

...
class SampleValueTest {
    ...
    void ofGeoPolygon() throws JsonProcessingException {
        ...
        assertThat(testSample.jsonify()).isEqualTo("\"POLYGON ((10.2 30.8, 56.1 87.5, 75 10, 10.2 30.8))\"");
    }
    ...
    void ofGeoMultiLine() throws JsonProcessingException {
        ...
        assertThat(testSample.jsonify()).isEqualTo("\"MULTILINESTRING ((10.2 30.8, 56.1 87.5), (1 2, 3 4))\"");
    }
    ...
    void ofGeoMultiPolygon() throws JsonProcessingException {
        ...
        assertThat(testSample.jsonify()).isEqualTo("\"MULTIPOLYGON (((10.2 30.8, 56.1 87.5, 75 10, 10.2 30.8)), ((1 2, 3 4, 5 6, 1 2)))\"");
    }
}
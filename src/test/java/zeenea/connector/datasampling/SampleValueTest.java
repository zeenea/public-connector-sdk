...
class SampleValueTest {
  ...
  abstract static class IdentifierMixin {
    @JsonValue
    abstract List<IdentificationProperty> getIdentificationProperties();
  }

  private static final ObjectMapper MAPPER =
      new ObjectMapper()
          .addMixIn(SampleValue.GenericSampleValue.class, ValueMixin.class)
          .addMixIn(ItemIdentifier.class, IdentifierMixin.class);
  ...
  void ofMapOfMap() throws JsonProcessingException {
    ...
    subMap.put("sub1", "toto");
    subMap.put("sub2", "tata");

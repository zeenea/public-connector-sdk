...
public class SourceBusinessTermTest {
  ...
  static final StringMetadata DEFAULT_METADATA_KEY =
      new StringMetadata("business-term-property-key");
  ...
  public void businessTermBuilderShouldReturnAProperBusinessTerm() {
    ...
    SourceBusinessTerm sourceBusinessTerm =
    ...
    assertSame(
        DEFAULT_CONTACT_RELATION, sourceBusinessTerm.getContactRelations().iterator().next());
  ...
  public void businessTermBuilderShouldAddProperties() {
    ...
    assertEquals(
        ...
        sourceBusinessTerm.getMetadata().get(urlMetadataWithoutLabel.getCode()));
    assertEquals(
        urlValueWithLabel, sourceBusinessTerm.getMetadata().get(urlMetadataWithLabel.getCode()));
  }

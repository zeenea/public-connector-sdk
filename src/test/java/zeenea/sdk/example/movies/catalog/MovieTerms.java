...
public class MovieTerms {
  ...
  public static SourceBusinessTerm MOVIE =
  ...
  public static SourceBusinessTerm CASTING =
      SourceBusinessTerm.builder()
          .id("casting")
          .name("Casting")
  ...
  public static SourceBusinessTerm RATING =
      SourceBusinessTerm.builder()
          .id("rating")
          .name("Rating")
  ...
  public static SourceBusinessTerm ADVERTISEMENT =
      SourceBusinessTerm.builder()
          .id("advertisement")
          .name("Advertisement")
          .description(
